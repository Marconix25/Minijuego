...
musica_fondo = pygame.mixer.Sound(
    'JuegoFinal/TheLegendOfZelda/sonido/ostfondo.wav')
...
laser_sonido = pygame.mixer.Sound(
    'JuegoFinal/TheLegendOfZelda/sonido/golpe.wav')
laser_enemigo = pygame.mixer.Sound(
    'JuegoFinal/TheLegendOfZelda/sonido/disparo_enemigo.wav')
explosion_sonido = pygame.mixer.Sound(
    'JuegoFinal/TheLegendOfZelda/sonido/explosion.wav')
herida_sonido = pygame.mixer.Sound(
    'JuegoFinal/TheLegendOfZelda/sonido/herida.wav')
# Pantalla - ventana
W, H = 1000, 600
PANTALLA = pygame.display.set_mode((W, H))
pygame.display.set_caption('TLOZ')
icono = pygame.image.load(
    'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo1.png')
...
score = 0
# Fondo del juego
fondo = pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/fondo.png')
# Pantalla de inicio
intro = pygame.image.load(
    'JuegoFinal/TheLegendOfZelda/imagenes/intro/intro.png')
...
for i in range(1, 13):
    explosion = pygame.image.load(
        f'JuegoFinal/TheLegendOfZelda/explosion/{i}.png')
...
class Jugador(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.quieto = pygame.image.load(
            'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo1.png')
        self.caminaDerecha = [pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/link/link_der6.png'),
                              pygame.image.load(
                                  'JuegoFinal/TheLegendOfZelda/imagenes/link/link_der5.png'),
                              pygame.image.load(
                                  'JuegoFinal/TheLegendOfZelda/imagenes/link/link_der4.png'),
                              pygame.image.load(
                                  'JuegoFinal/TheLegendOfZelda/imagenes/link/link_der3.png'),
                              pygame.image.load(
                                  'JuegoFinal/TheLegendOfZelda/imagenes/link/link_der2.png'),
                              pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/link/link_der1.png')]

        self.caminaIzquierda = [pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/link/link_izq1.png'),
                                pygame.image.load(
                                    'JuegoFinal/TheLegendOfZelda/imagenes/link/link_izq2.png'),
                                pygame.image.load(
                                    'JuegoFinal/TheLegendOfZelda/imagenes/link/link_izq3.png'),
                                pygame.image.load(
                                    'JuegoFinal/TheLegendOfZelda/imagenes/link/link_izq4.png'),
                                pygame.image.load(
                                    'JuegoFinal/TheLegendOfZelda/imagenes/link/link_izq5.png'),
                                pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/link/link_izq6.png')]
        self.caminaArriba = [pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba1.png'),
                             pygame.image.load(
                                 'JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba2.png'),
                             pygame.image.load(
                                 'JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba3.png'),
                             pygame.image.load(
                                 'JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba4.png'),
                             pygame.image.load(
                                 'JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba5.png'),
                             pygame.image.load(
                                 'JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba6.png'),
                             pygame.image.load(
                                 'JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba7.png'),
                             pygame.image.load(
                                 'JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba8.png'),
                             pygame.image.load(
                                 'JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba9.png'),
                             pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/link/link_arriba10.png'),]

        self.caminaAbajo = [
            pygame.image.load(
                'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo2.png'),
            pygame.image.load(
                'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo3.png'),
            pygame.image.load(
                'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo4.png'),
            pygame.image.load(
                'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo5.png'),
            pygame.image.load(
                'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo6.png'),
            pygame.image.load(
                'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo7.png'),
            pygame.image.load(
                'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo8.png'),
            pygame.image.load(
                'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo9.png'),
            pygame.image.load(
                'JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo10.png'),
            pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/link/link_abajo11.png')]
        self.salta = [pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/link/link_salto1.png'),
                      pygame.image.load('JuegoFinal/TheLegendOfZelda/imagenes/link/link_salto2.png')]
...
# Movimiento arriba
        ...
        botonIzq = pygame.joystick.Joystick(0).get_button(4)
        botonArr = pygame.joystick.Joystick(0).get_button(3)
        botonDer = pygame.joystick.Joystick(0).get_button(5)
        botonAba = pygame.joystick.Joystick(0).get_button(0)
        botonSal = pygame.joystick.Joystick(0).get_button(1)

        # Tecla A - Moviemiento a la izquierda
        if botonIzq == 1 and self.px > self.velocidad:
    ...
    # Tecla D - Moviemiento a la derecha
        elif botonDer == 1 and self.px < 900 - self.velocidad - self.ancho:
            self.px += self.velocidad
            self.izquierda = False
            self.derecha = True
            self.arriba = False
...
# Tecla W - Moviemiento hacia arriba
        elif botonArr == 1 and self.py > 400:
    ...
    # Tecla S - Moviemiento hacia abajo
        elif botonAba == 1 and self.py < 500:
            self.py += self.velocidad
            self.izquierda = False
            self.derecha = False
            self.arriba = False
...
class Enemigos (pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load(
            'JuegoFinal/TheLegendOfZelda/imagenes/enemigo/pulpo.png').convert_alpha()
        self.rect = self.image.get_rect()
...
class Balas (pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load(
            'JuegoFinal/TheLegendOfZelda/imagenes/link/espada.png').convert_alpha()
        self.rect = self.image.get_rect()
        self.rect.centerx = x
        self.rect.y = y
        self.velocidad = -18
...
class Balas_enemigos(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load(
            'JuegoFinal/TheLegendOfZelda/imagenes/enemigo/bala.png').convert_alpha()
...
while ejecuta:
    ...
    # Fondo en movimiento
    controlDer = pygame.joystick.Joystick(0).get_button(5)
    controlIzq = pygame.joystick.Joystick(0).get_button(4)
    if controlDer == 1:
        POS -= 5
    if controlIzq == 1:
        POS += 5
